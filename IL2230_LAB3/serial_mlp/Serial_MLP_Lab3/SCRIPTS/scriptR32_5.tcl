...
######Read Design###########
analyze -library WORK -format vhdl ${SRCDIR}/neuron_pkgR32_5.vhd
...
#######Report####################
report_timing > ${RPTDIR}/report_timingR32_5.rpt
report_area > 	${RPTDIR}/report_areaR32_5.rpt
report_cell > 	${RPTDIR}/report_cellR32_5.rpt
report_power -analysis_effort low > $RPTDIR/report_powerR32_5.rpt
#######Save Design####################
write -hierarchy -format ddc -output ${SYNDB}/mainR32_5.ddc
write -format verilog -hier -o ${SYNDB}/mainR32_5.v
write_sdf -version 2.1 ${SYNDB}/mainR32_5.sdf