...
######Read Design###########
analyze -library WORK -format vhdl ${SRCDIR}/neuron_pkgR8_5_20.vhd
...
#######Report####################
report_timing > ${RPTDIR}/report_timingR8_5_20.rpt
report_area > 	${RPTDIR}/report_areaR8_5_20.rpt
report_cell > 	${RPTDIR}/report_cellR8_5_20.rpt
report_power -analysis_effort low > $RPTDIR/report_powerR8_5_20.rpt
#######Save Design####################
write -hierarchy -format ddc -output ${SYNDB}/mainR8_5_20.ddc
write -format verilog -hier -o ${SYNDB}/mainR8_5_20.v
write_sdf -version 2.1 ${SYNDB}/mainR8_5_20.sdf