...
######Read Design###########
analyze -library WORK -format vhdl ${SRCDIR}/neuron_pkgG8_5.vhd
...
#######Report####################
report_timing > ${RPTDIR}/report_timingG8_5.rpt
report_area > 	${RPTDIR}/report_areaG8_5.rpt
report_cell > 	${RPTDIR}/report_cellG8_5.rpt
report_power -analysis_effort low > $RPTDIR/report_powerG8_5.rpt
#######Save Design####################
write -hierarchy -format ddc -output ${SYNDB}/mainG8_5.ddc
write -format verilog -hier -o ${SYNDB}/mainG8_5.v
write_sdf -version 2.1 ${SYNDB}/mainG8_5.sdf